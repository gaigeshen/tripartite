 ...
 * @author gaigeshen
 */
public interface DingAccessTokenUpdateTask extends Runnable {
    /**
     * 设置访问令牌存储器到此任务，此存储器用于获取访问令牌和保存更新之后的访问令牌
     *
     * @param accessTokenStore 访问令牌存储器
     */
    void setAccessTokenStore(DingAccessTokenStore accessTokenStore);
     ...
     */
    void setAccessTokenUpdateListener(DingAccessTokenUpdateListener accessTokenUpdateListener);
     ...
     * @param config 配置信息
     */
    void setConfig(DingConfig config);
     ...
     * @return 访问令牌存储器
     */
    DingAccessTokenStore getAccessTokenStore();
     ...
     * @return 访问令牌更新监听器
     */
    DingAccessTokenUpdateListener getAccessTokenUpdateListener();
