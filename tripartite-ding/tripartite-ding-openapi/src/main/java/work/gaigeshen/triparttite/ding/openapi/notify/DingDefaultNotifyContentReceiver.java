package work.gaigeshen.triparttite.ding.openapi.notify;
...
import work.gaigeshen.triparttite.core.notify.NotifyContentIncorrectException;
...
public class DingDefaultNotifyContentReceiver extends AbstractNotifyContentReceiver<DefaultNotifyContent> {
  ...
  private final DingCompositeClients dingClients;

  public DingDefaultNotifyContentReceiver(DingCompositeClients clients) {
  ...
  protected DefaultNotifyContent validate(DefaultNotifyContent content) throws NotifyContentIncorrectException {
    ...
    DingConfig dingConfig = dingClients.getConfig(appKey);
