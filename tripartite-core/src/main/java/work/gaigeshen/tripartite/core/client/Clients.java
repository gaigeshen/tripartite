...
public interface Clients<C extends Config> {
     ...
     *
     * @return 获取到的接口客户端
     * @throws ClientNotFoundException 接口客户端未找到的异常
     */
    ...
    /**
     * 获取配置信息，由于配置信息是从关联的接口客户端中获取的，所以如果未找到指定的接口客户端则会抛出异常
     *
    ...
    /**
     * 调用此方法将有可能创建新的接口客户端，如果指定的接口客户端不存在的话
     *
     * @param config 配置信息
     * @return 获取到的接口客户端
     * @throws ClientCreationException 在需要创建接口客户端的时候，如果创建接口客户端失败的情况将抛出此异常
     */
