...
public interface WebExecutor {
    ...
    <T> T executePut(String url, Parameters parameters, Class<T> responseClass, Object... uriVariables) throws WebException;

    <T> T executePut(String url, Parameters parameters, ResponseConverter<T> converter, Object... uriVariables) throws WebException;
    ...
    <T> T executePut(String url, Object parameters, Class<T> responseClass, Object... uriVariables) throws WebException;

    <T> T executePut(String url, Object parameters, ResponseConverter<T> converter, Object... uriVariables) throws WebException;
    ...
    <T> T executePut(String url, ParametersCreator creator, Class<T> responseClass, Object... uriVariables) throws WebException;
