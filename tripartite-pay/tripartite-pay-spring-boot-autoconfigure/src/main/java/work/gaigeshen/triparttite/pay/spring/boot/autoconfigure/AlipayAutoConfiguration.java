...
import work.gaigeshen.triparttite.pay.alipay.*;
import work.gaigeshen.triparttite.pay.alipay.config.AlipayConfig;
import work.gaigeshen.triparttite.pay.alipay.notify.AlipayNotifyParameters;
import work.gaigeshen.triparttite.pay.alipay.notify.AlipayNotifyParametersFilter;
import work.gaigeshen.triparttite.pay.alipay.notify.AlipayNotifyParametersReceiver;
...
public class AlipayAutoConfiguration {
  ...
  public AlipayClients alipayClients() {
    ...
    for (AlipayProperties.Client client : alipayProperties.getClients()) {
      ...
      alipayClients.add(DefaultAlipayClient.create(alipayConfig, new AlipayInterceptor(alipayConfig)));
